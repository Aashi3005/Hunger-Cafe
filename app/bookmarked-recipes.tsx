...
export default function BookmarkedRecipesScreen() {
  ...
  const loadBookmarkedRecipes = async () => {
    try {
      const recipes = await RecipeStorage.getBookmarkedRecipes();
  ...
  }, [bookmarkedRecipes, searchQuery, selectedCuisine, selectedTimeFilter, selectedTag]);
  ...
  const handleRemoveBookmarked = async (recipeId: string) => {
    try {
      await RecipeStorage.removeBookmarkedRecipe(recipeId);
      ...
      Alert.alert('Error', 'Failed to remove recipe from bookmarks');
    }
  };
  ...
  const renderRecipeCard = (recipe: Recipe) => (
    <View key={recipe.id} style={styles.recipeCard}>
      ...
      <TouchableOpacity
        ...
        onPress={() => handleRemoveBookmarked(recipe.id)}
      >
    ...
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyDescription}>
        {searchQuery || selectedCuisine !== 'All' || selectedTimeFilter !== 'All' || selectedTag !== 'All'
          ...
          : 'Start bookmarking recipes to save them for later. Your bookmarked recipes will appear here!'}
      </Text>
      {!(searchQuery || selectedCuisine !== 'All' || selectedTimeFilter !== 'All' || selectedTag !== 'All') && (
        <TouchableOpacity
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Bookmarked Recipes</Text>
